...
class VideoClipParams(BaseModel):
    ...
    custom_position: float = 60.0       # 自定义位置（距顶部百分比）
    ...
    narration_workflow_mode: Optional[str] = Field(
        default=None,
        description="脚本工作流：summary=短剧解说，film_tv=影视解说，等",
    )
