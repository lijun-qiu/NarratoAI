...
## 任务目标
我是一位专业的影视解说up主，需要为《${drama_name}》的混剪片段创作一份高质量的解说脚本。目标是让观众在短时间内了解这段剧情在整部作品中的位置与精华，并产生强烈的继续观看欲望。

## 创作前提
在撰写解说前，请先结合你对《${drama_name}》的了解，理解本片段字幕所讲述的内容在全片中的意义——包括涉及的人物关系、前因后果和情绪基调。解说文案应准确反映片段内容，并适当点出与整部作品相关的背景信息，帮助观众理解「这段在讲什么、为什么重要」。
...
现在请基于以上要求，为《${drama_name}》的混剪片段创作解说脚本："""
